...
const TEMP_DB_SCHEMA = `
      ...
      ### invoice_folios //Esta tabla es la principal para generar reportes de facturación, esta debe ser la tabla central cuando se pidan reportes de facturación
